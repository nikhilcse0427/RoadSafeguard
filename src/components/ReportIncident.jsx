...
function IncidentForm({ formData, onChange, onSubmit, onReset }) {
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <div>
        ...
        <button
          type="button"
          onClick={onReset}
          className="ml-3 px-5 py-2.5 bg-white border border-gray-300 hover:bg-gray-100 text-gray-700 font-medium rounded-lg transition"
        >
          Reset Form
        </button>
      </div>
